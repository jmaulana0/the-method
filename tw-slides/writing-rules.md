# TW Slides — Writing Rules

General writing standards for any text that lands on a slide. This file covers *what to say and how to say it*. See `slide-setup.md` for canvas/font/grid mechanics and `deck-playbook.md` for *how to approach the deck as a whole*.

These rules apply to every slide regardless of type. They are non-negotiable — the quality of the writing is what separates a polished MBB-grade deck from an amateur one.

---

## Action titles, not topic labels

Every slide title must be a **conclusion**, not a topic.

- **Bad**: "Market size"
- **Good**: "ANZ e-commerce market growing at 18% CAGR through 2027"
...
A 10-word elaboration below the Action Title. Adds units, context, or a qualifying clause. Optional — use only when the title needs clarifying.
...
6. **No clotheslines**: bullet lists must be grouped and structured, not enumerated randomly. Group bullets into 3–4 named categories.
...
These habits separate polished output from amateur slides:
...
All Turing Works slides use **UK/Australian English** spelling. Never use American English spellings.

Rules:
- **-ise** not -ize (organise, optimise, minimise)
- **-yse** not -yze (analyse, paralyse)
- **-our** not -or (colour, favour, behaviour)
- **-re** not -er (centre, fibre, metre)
- **-lled / -lling** not -led / -ling (modelled, travelling — double the consonant)
- **-ogue** not -og (dialogue, catalogue)
- **-ence** not -ense for nouns (licence, defence)
...
Slide text must meet GMAT sentence-correction standards. Every sentence on a slide must pass these.

### Sentence structure

- **Parallelism**: items in a list, comparison, or series must share identical grammatical form.
  - Bad: "We will assess risk, reducing costs, and the optimisation of processes."
  - Good: "We will assess risk, reduce costs, and optimise processes."
- **Modifiers**: place modifiers directly next to the word they modify.
  - Bad: "Using advanced analytics, the market was analysed."
  - Good: "Using advanced analytics, we analysed the market."
- **Subject–verb agreement**: the verb must agree with the true subject, not an intervening phrase.
  - Bad: "The portfolio of investments are growing."
  - Good: "The portfolio of investments is growing."

### Comparisons

- **Like vs. such as**: "like" draws a comparison (similarity); "such as" introduces examples.
  - Bad (if meaning those specific markets): "Markets like Australia and the UK…"
  - Good: "Markets such as Australia and the UK…"
- **Compare parallel structures**: compare equivalent things.
  - Bad: "Revenue in Q1 was higher than Q2."
  - Good: "Revenue in Q1 was higher than revenue in Q2" or "…than in Q2."
...
- Every pronoun must have an unambiguous antecedent.
  - Bad: "The team reviewed the report and updated it, which improved it."
  - Good: "The team reviewed the report, updated the data, and improved overall accuracy."
...
- Eliminate weak constructions: "There are three factors that…" → "Three factors…"; "It is important to note that…" → delete entirely
...
Slide text operates under extreme space constraints. Every sentence must maximise information density while remaining instantly clear.
...
- Bullets that are **not full sentences** do not get a full stop.
- Bullets that **are full sentences** do.
...
- **Hyphenation**: pick a form for every hyphenated term and lock it in. "AI-powered" and "AI powered" cannot both appear in the same deck.
